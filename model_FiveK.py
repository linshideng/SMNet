...
class lowlightnet3(nn.Module):
    ...
    def forward(self, x_ori, tar=None):
        ...
        cat_all = torch.cat((ende_fullres_out,ende_quarres_up_up,ende_halfres_up),dim=1)
        ...
        cat_all2 = torch.cat((ende_fullres_out2,ende_quarres_up_up2,ende_halfres_up2),dim=1)
        fusion_all2 = self.out_fushion(cat_all2)
        fusion_out2 = self.out_conv2(fusion_all2) +fullres2

        out2 = self.out_conv4(self.dim2four(fusion_out2)+x_bright)
        ...
        return out3, out2, out1, \
            ...
            ende_quarres2,ende_halfres2,ende_fullres_out2,\
                ende_quarres,ende_halfres,ende_fullres_out
